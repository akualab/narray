...
func Copysign(out, a, b *NArray) *NArray {
	...
	for k, v := range a.Data {
		out.Data[k] = float64(math.Copysign(float64(v), float64(b.Data[k])))
	}
	return out
}
...
func Max(out, a, b *NArray) *NArray {
	...
	for k, v := range a.Data {
		out.Data[k] = float64(math.Max(float64(v), float64(b.Data[k])))
	}
	return out
}
...
func Min(out, a, b *NArray) *NArray {
	...
	for k, v := range a.Data {
		out.Data[k] = float64(math.Min(float64(v), float64(b.Data[k])))
	}
	return out
}
